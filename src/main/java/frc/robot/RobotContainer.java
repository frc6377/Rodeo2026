...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser.addOption(
                ...
                drive.sysIdTurningQuasistatic(SysIdRoutine.Direction.kForward));
        autoChooser.addOption(
                "Drive SysId Turning (Quasistatic Backward)",
                drive.sysIdTurningQuasistatic(SysIdRoutine.Direction.kReverse));
        autoChooser.addOption(
                "Drive SysId Turning (Dynamic Forward)", drive.sysIdTurningDynamic(SysIdRoutine.Direction.kForward));
        autoChooser.addOption(
                "Drive SysId Turning (Dynamic Backward)", drive.sysIdTurningDynamic(SysIdRoutine.Direction.kReverse));
    ...
    private void configureButtonBindings() {
        ...
        drive.setDefaultCommand(DriveCommands.joystickDrive(
                drive, controller.driveTranslationY(), controller.driveTranslationX(), controller.driveRotation()));
