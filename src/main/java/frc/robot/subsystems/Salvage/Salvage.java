...
public class Salvage extends SubsystemBase {
    ...
    private final SmartMotorControllerConfig config = new SmartMotorControllerConfig(this)
            .withClosedLoopController(10, 2, 0)
            .withSimClosedLoopController(50, 10, 1)
    ...
    private final SparkWrapper salvagePivotController = new SparkWrapper(salvagePivotMotor, DCMotor.getCIM(2), config);
    ...
    private ArmConfig salvagePivotArmConfig = new ArmConfig(salvagePivotController)
            ...
            .withTelemetry("Salvage Pivot Arm", TelemetryVerbosity.LOW)
